...
class rawImage:
    ...
    def findDeviation(self):
        ...
        if y_lines is None:
            ...
            vars.deviation, vars.y, vars.w = 0, -1, -1
            return
        ...
        if y_offset == -float("inf"):
            ...
            vars.deviation, vars.y, vars.w = 0, 0, -1
            return
        ...
        if w_lines is None:
            ...
            vars.deviation, vars.y, vars.w = y_offset, 1, -1
            return
        ...
        if w_offset == float("inf"):
            ...
            vars.deviation, vars.y, vars.w = y_offset, 1, 0
            return
        ...
        """
        #print("deviation = {}".format(deviation))
        vars.deviation, vars.y, vars.w = deviation, 1, 1
        return
